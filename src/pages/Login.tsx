          ...
          <div className="px-8 pt-8 pb-6 border-b border-border text-center">
            ...
            >
              ...
              <img
                ...
                className="absolute top-1/2 left-[50%] -translate-x-1/2 -translate-y-1/2 h-64 w-auto object-contain drop-shadow-2xl pointer-events-none dark:mix-blend-screen mix-blend-exclusion"
                style={{
