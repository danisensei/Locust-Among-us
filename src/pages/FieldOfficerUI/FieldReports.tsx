                  ...
                  <div className="flex flex-wrap gap-3">
                    {RISK_LEVELS.map(rl => (
                      <button
                        ...
                        className={`px-4 py-2 rounded-lg text-sm font-semibold border transition-all duration-200 ${riskLevel === rl.value
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-1 bg-muted/30 border border-border/50 rounded-lg p-1">
                      <button
                        ...
                        className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium transition-all ${locationMode === 'map'
                      ...
                      <button
                        ...
                        className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium transition-all ${locationMode === 'manual'
                          ? 'bg-background shadow-sm text-foreground'
                          : 'text-muted-foreground hover:text-foreground'
                          }`}
                      >
        ...
        <div className="p-4 border-b border-border/50 bg-muted/20 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            <div className="relative flex-1 sm:w-64">
              ...
              <Input
                placeholder="Search report ID, zone..."
                value={search}
            ...
            <Button type="button" variant="ghost" size="sm" onClick={fetchReports} disabled={loadingReports} className="h-9 w-9 p-0 hover:bg-sky-500/10 hover:text-sky-400 transition-colors shrink-0">
              ...
              <div className="relative p-6 pb-8 bg-gradient-to-br from-sky-500/10 via-background to-background border-b border-border/50">
                ...
                <DialogHeader className="relative z-10">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    {/* Status Badge */}
                    <div className={`px-4 py-1.5 rounded-full border shadow-sm flex items-center gap-2 text-sm font-semibold tracking-wide ${detailReport.status === 'Verified' ? 'bg-emerald-500/10 border-emerald-500/30 text-emerald-400'
              ...
              <div className="p-6 space-y-6 overflow-y-auto max-h-[60vh]">
                ...
                <div className="space-y-2">
                  ...
                  {detailReport.reviewed_by ? (
                    <div className={`rounded-2xl p-5 border shadow-sm relative overflow-hidden ${detailReport.status === 'Verified' ? 'bg-gradient-to-r from-emerald-500/10 to-transparent border-emerald-500/20'
